...
public class parametros {
	...
	public static void NivelDificutlad(Node numCiudadesInfectadasInicio, Node numCuidadesInfectadasRonda,
			Node numEnfermedadesActivasDerrota, Node numBrotesDerrota, int opcion) {

		switch (opcion) {
		// dependiendo de la opcion cambia la dificultad
		case 1:
			// Cambia los parametros en el xml
			numCiudadesInfectadasInicio.setTextContent("2");
	...
	public int InfectarCiudades(int CiuInfInicio) {
		// al comienzo de la partida se van a infectar 9 ciudades
		int a = CiuInfInicio;
	...
	public int InfeccionRonda(int CiuInfIRonda) {
		// a cada ronda infectara 4 ciudades
		int a = CiuInfIRonda;
	...
	public int NumEnfermedadesActivas(int EnfActDerrota) {
		// si el total de enfermedades es 30 o superior se pierde la partida
		int a = EnfActDerrota;
	...
	public int NumBrotes(int NumBroDerrota) {
		// si el numero de brotes es 8 o superiro se puierde la partida
		int a = NumBroDerrota;
